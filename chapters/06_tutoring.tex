...
\begin{framed}
	...
	\begin{itemize}
		...
		\item Demonstration of the application of \acrshort{sparc} to teach a robot a policy to interact with humans \emph{in situ}, in a social environment which is complex, indeterministic, high dimensional and multimodal.
	\end{itemize}
\end{framed}
