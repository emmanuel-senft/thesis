...
\begin{table}[ht]
	...
	\begin{tabularx}{\textwidth}{@{}L{.65}L{1.05}L{.15}L{2.15}@{}}\toprule
		...
		& Progress in the Game & 1 & 0.25 for \nth{1} game to 1 for the last game\\ 
