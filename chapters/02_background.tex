...
%using human intuition to make the system achieve a better performance faster
%requirement to test it with end users

\subsection{Active learning} \label{ssec:back_active}
%More supervised - learner driven - reduce workload on user
%learning from a human in a supervised learning fashion, but not applicable to learn HRI as the sample cannot be generated at will
