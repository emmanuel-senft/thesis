...
The principles described in the previous section have also implications on the interactions between the teacher and the agent and between the agent and the environment.
