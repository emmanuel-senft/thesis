...
This chapter extended \gls{sparc} and compared it to an other method from the \gls{iml} field. \gls{sparc} succeeded in its goal, allowing participants to teach easily and safely a policy to a robot. Finally, these encouraging results were sufficient to move on to 
