...
\begin{minipage}[t]{0.5\textwidth}
	...
	\begin{algorithm}[H]
		...
		\begin{minipage}{0.9\linewidth}
			...
			$A_{t+1}=[a_{1}...a_n]$, $n$ actions with high $Q[s_{t+1},a]$
					
%			\vspace{5.5pt}
			
			\While{waiting for guidance and reward on $a_{t+1}$ (2 seconds)}{
				\If{$n>1$}{
					indicate confusion 
				}
