...
\begin{itemize}
	\item [RQ5] \emph{When a human teaches a robot to interact with other humans, what are the impacts in term of performance in the target application, comfort for the teacher and robot learning?}
...
\begin{itemize}
	...
	\item We showed that by \textbf{learning from a human commands}, a robot can reduce the need for the human to manually select actions for the robot, and this further \textbf{reduces the workload on this human operator}. (Chapter~\ref{chap:woz}; \citealt{senft2015sparc})	
