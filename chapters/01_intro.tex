...
Additionally, the term `policy' is used many times throughout this manuscript and can be approximated by a mapping between perceived states and actions executed in that state~\citep{sutton1998reinforcement}. This policy can be deterministic or stochastic but is sufficient to determine and characterise an agent's behaviour.
