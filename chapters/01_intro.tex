...
\begin{itemize}
	\item [RQ1] \textbf{What are the requirements of a robot controller to ensure a behaviour suited to \gls{hri}?} 
		...
		By interacting with humans, robots enter the social world and have to conform to human expectations and ensure that they can reach their goal. This research question studies how the constraints interacting on the human world put on the robot's controller. %Not ideal...
...
\subsection{Flow of the thesis}%Will change!
