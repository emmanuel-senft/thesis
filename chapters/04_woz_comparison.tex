...
\begin{framed}
	...
	\begin{itemize}
		\item Design of an experiment to explore the influence of \acrshort{sparc} on the human workload and task performance compared to an approach based on \acrshort{woz}.
		...
		\item Evaluation in a within subject design with 10 participant.
		\item Results show that \acrshort{sparc} achieves a similar performance than \acrshort{woz} while requiring a lower workload from the teacher.
	\end{itemize}
\end{framed}
